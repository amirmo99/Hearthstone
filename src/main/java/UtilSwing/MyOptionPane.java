...
public class MyOptionPane extends JOptionPane {
    ...
    public Card showCardChooser(List<Card> cards, String message) {
        ...
        model = null;
        ModelViewerScroll cardsViewer = new ModelViewerScroll(new MyAction(), true, false, false, false);
    ...
    public InfoPassive showPassivesChooser(List<InfoPassive> infoPassives) {
        model = null;
        ModelViewerScroll passiveViewer = new ModelViewerScroll(new MyAction(), true, false, false, false);
