...
public class Deck implements Comparable, Prototype {
    ...
    private Deck(String heroName, String name, int wonGames, int playedGames, List<Card> cards) {
    ...
    public Deck(String heroName, String deckName, List<Card> cards) {
        this(heroName, deckName, 0, 0, cards);
    }

    public Deck(String heroName, String name) {
        this(heroName, name, 0, 0, new ArrayList<>());
    }
    ...
    public Deck cloned() {
        ...
        return new Deck(heroName, name, wonGames, playedGames, cardList);
    }
    ...
    public int compareTo(Object o) {
        ...
        return (victoryRate() > deck2.victoryRate() ||
