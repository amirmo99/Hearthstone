...
public class PlayerBoardViewer extends JPanel {
    ...
    private final List<Minion> mainList;

    boolean highlightEmptySpots;

    public PlayerBoardViewer(int size, double width, List<Minion> cards) {
        this.size = size;
        this.width = width;
        this.mainList = cards;
    ...
    public void update(boolean highlightEmptySpots) {
        this.cardsToPaint = new ArrayList<>(mainList);
