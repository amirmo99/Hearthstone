...
public class ModelViewerPanel extends JPanel {
    ...
    public ModelViewerPanel(MyButtonAction cardAction, boolean onlyOneRow, boolean viewOnly, boolean showLock, boolean drawAbilities) {
        super();
    ...
    private ModelPanel createModel(GameModel model) {
        ...
        if (model instanceof Card) {
            ...
            boolean lock = (showLock) && PlayerMapper.getInstance().isCardLocked(card);
